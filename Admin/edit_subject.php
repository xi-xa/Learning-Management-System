...
<body>
    ...
    $sql = "SELECT * FROM tbl_subject WHERE subID = '$subID'";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE tbl_subject SET subject = '$subject', subject_code = '$subject_code', grade_level = '$grade_level' WHERE subID = '$subID'";
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form method="post">
                ...
                <input type="text" id="subject_code" name="subject_code" value="<?php echo $row['subject_code']; ?>"
                    required>
                ...
                <div class="btn-group">
                    <input type="submit" class="btn btn-submit" value="Update Subject">
