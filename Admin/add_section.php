    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form action="" method="post">
                ...
                <div class="btn-group">
                    <input type="submit" class="btn btn-submit" value="Add Section">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            try {
                ...
                $sql1 = "INSERT INTO tbl_section (section, section_code)
             VALUES ('$section', '$section_code')";
                $conn->query($sql1);

                // SQL query to insert data into tbl_gradelevel
                $sql2 = "INSERT INTO tbl_gradelevel (grade_level)
             VALUES ('$grade_level')";
                $conn->query($sql2);

                // Commit transaction
                $conn->commit();
                echo "<script>alert('Section added successfully!'); window.location.href='manage_classes.php';</script>";
            } catch (Exception $e) {
